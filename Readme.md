AutoHotKey Is easy, but user cannot use the computer when the program is running. AutoHotKey Could just be a short bodge, and could not fix this issue forever.
